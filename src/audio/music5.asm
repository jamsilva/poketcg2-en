...
_AssertSongFinished_5::
	jp Music5_AssertSongFinished

_AssertSFXFinished_5::
	jp Music5_AssertSFXFinished
...
_ResumeSong_5::
	jp Music5_ResumeSong

Music5_PlaySong:
	call Music5_LoadAudioWRAMBank
	push hl
	ld hl, NumberOfSongs5
	cp [hl]
	jr nc, .invalidID
	ld [wCurSongID], a
.invalidID
...
.zero_loop1
	...
	cp $4
	jr nz, .zero_loop1
	ld hl, Music5_ChannelLoopStacks
...
Music5_Update:
	call Music5_LoadAudioWRAMBank2
	call Music5_EmptyFunc
	call Music5_CheckForNewSound
	ld hl, SFX_UpdateSFX
...
.update_channels
	call Music5_UpdateChannel1
	call Music5_UpdateChannel2
	call Music5_UpdateChannel3
	call Music5_UpdateChannel4
.skip_channel_Updates
	call Music5_f4866
	call Music5_CheckForEndOfSong
	ld a, [wAudio_d011]
	or a
	jr z, .asm_1dc17b
	call Music5_BackupSong
	xor a
	ld [wAudio_d011], a
.asm_1dc17b
	call Music5_UnloadAudioWRAMBank2
	ret

Music5_CheckForNewSound:
	ld a, [wCurSongID]
	rla
	jr c, .check_for_new_sfx
	call Music5_StopAllChannels
	ld a, [wCurSongID]
	call Music5_BeginSong
	ld a, [wCurSongID]
	or $80
	ld [wCurSongID], a
.check_for_new_sfx
...
Music5_BeginSong:
	...
	ld [wAudio_d070], a
	ld [wAudio_d080], a
	ld a, [Music5_ChannelLoopStacks]
	ld [wMusicChannelStackPointers], a
	ld a, [Music5_ChannelLoopStacks + 1]
...
.no_channel_1
	...
	ld [wAudio_d070 + 1], a
	ld [wAudio_d080 + 1], a
	ld a, [Music5_ChannelLoopStacks + 2]
	ld [wMusicChannelStackPointers + 2], a
	ld a, [Music5_ChannelLoopStacks + 3]
...
.no_channel_2
	...
	ld [wAudio_d070 + 2], a
	ld [wAudio_d080 + 2], a
	ld a, [Music5_ChannelLoopStacks + 4]
	ld [wMusicChannelStackPointers + 4], a
	ld a, [Music5_ChannelLoopStacks + 5]
...
.no_channel_3
	...
	ld [wAudio_d070 + 3], a
	ld [wAudio_d087], a
	ld a, [Music5_ChannelLoopStacks + 6]
	ld [wMusicChannelStackPointers + 6], a
	ld a, [Music5_ChannelLoopStacks + 7]
...
Music5_CommandTable:
	...
	dw Music5_octave
	dw Music5_octave
	dw Music5_inc_octave
	dw Music5_dec_octave
	dw Music5_tie
	dw Music5_end
	dw Music5_end
	dw Music5_stereo_panning
	dw Music5_MainLoop
	dw Music5_EndMainLoop
	dw Music5_Loop
	dw Music5_EndLoop
	dw Music5_jp
	dw Music5_call
	dw Music5_ret
	dw Music5_frequency_offset
	dw Music5_duty
	dw Music5_volume
	dw Music5_wave
	dw Music5_cutoff
	dw Music5_echo
	dw Music5_vibrato_type
	dw Music5_vibrato_delay
	dw Music5_pitch_offset
	dw Music5_adjust_pitch_offset
	dw Music5_musicee
	dw Music5_musicef
	dw Music5_preset
	dw Music5_musicf1
...
Music5_Loop:
	...
	inc de
	push af
	call Music5_GetChannelStackPointer
	ld [hl], e ;
	...
	inc hl
	push de
	call Music5_SetChannelStackPointer
	jp Music5_PlayNextNote_pop
...
Music5_LoadWaveInstrument:
	ld a, [wMusicWave]
	add a
	ld d, $0
	ld e, a
	ld hl, Music5_WaveInstruments
	add hl, de
	ld a, [hli]
	ld h, [hl]
	ld l, a
...
Music5_WaveInstruments:
INCLUDE "audio/wave_instruments.asm"

Music5_NoiseInstruments:
