...
_AssertSongFinished_6::
	jp Music6_AssertSongFinished

_AssertSFXFinished_6::
	jp Music6_AssertSFXFinished
...
_ResumeSong_6::
	jp Music6_ResumeSong

Music6_PlaySong:
	call Music6_LoadAudioWRAMBank
	push hl
	ld hl, NumberOfSongs6
	cp [hl]
	jr nc, .invalidID
	ld [wCurSongID], a
.invalidID
...
.zero_loop1
	...
	cp $4
	jr nz, .zero_loop1
	ld hl, Music6_ChannelLoopStacks
...
Music6_Update:
	call Music6_LoadAudioWRAMBank2
	call Music6_EmptyFunc
	call Music6_CheckForNewSound
	ld hl, SFX_UpdateSFX
...
.update_channels
	call Music6_UpdateChannel1
	call Music6_UpdateChannel2
	call Music6_UpdateChannel3
	call Music6_UpdateChannel4
.skip_channel_Updates
	call Music6_f4866
	call Music6_CheckForEndOfSong
	ld a, [wAudio_d011]
	or a
	jr z, .asm_1dc17b
	call Music6_BackupSong
	xor a
	ld [wAudio_d011], a
.asm_1dc17b
	call Music6_UnloadAudioWRAMBank2
	ret

Music6_CheckForNewSound:
	ld a, [wCurSongID]
	rla
	jr c, .check_for_new_sfx
	call Music6_StopAllChannels
	ld a, [wCurSongID]
	call Music6_BeginSong
	ld a, [wCurSongID]
	or $80
	ld [wCurSongID], a
.check_for_new_sfx
...
Music6_BeginSong:
	...
	ld [wAudio_d070], a
	ld [wAudio_d080], a
	ld a, [Music6_ChannelLoopStacks]
	ld [wMusicChannelStackPointers], a
	ld a, [Music6_ChannelLoopStacks + 1]
...
.no_channel_1
	...
	ld [wAudio_d070 + 1], a
	ld [wAudio_d080 + 1], a
	ld a, [Music6_ChannelLoopStacks + 2]
	ld [wMusicChannelStackPointers + 2], a
	ld a, [Music6_ChannelLoopStacks + 3]
...
.no_channel_2
	...
	ld [wAudio_d070 + 2], a
	ld [wAudio_d080 + 2], a
	ld a, [Music6_ChannelLoopStacks + 4]
	ld [wMusicChannelStackPointers + 4], a
	ld a, [Music6_ChannelLoopStacks + 5]
...
.no_channel_3
	...
	ld [wAudio_d070 + 3], a
	ld [wAudio_d087], a
	ld a, [Music6_ChannelLoopStacks + 6]
	ld [wMusicChannelStackPointers + 6], a
	ld a, [Music6_ChannelLoopStacks + 7]
...
Music6_CommandTable:
	...
	dw Music6_octave
	dw Music6_octave
	dw Music6_inc_octave
	dw Music6_dec_octave
	dw Music6_tie
	dw Music6_end
	dw Music6_end
	dw Music6_stereo_panning
	dw Music6_MainLoop
	dw Music6_EndMainLoop
	dw Music6_Loop
	dw Music6_EndLoop
	dw Music6_jp
	dw Music6_call
	dw Music6_ret
	dw Music6_frequency_offset
	dw Music6_duty
	dw Music6_volume
	dw Music6_wave
	dw Music6_cutoff
	dw Music6_echo
	dw Music6_vibrato_type
	dw Music6_vibrato_delay
	dw Music6_pitch_offset
	dw Music6_adjust_pitch_offset
	dw Music6_musicee
	dw Music6_musicef
	dw Music6_preset
	dw Music6_musicf1
...
Music6_Loop:
	...
	inc de
	push af
	call Music6_GetChannelStackPointer
	ld [hl], e ;
	...
	inc hl
	push de
	call Music6_SetChannelStackPointer
	jp Music6_PlayNextNote_pop
...
Music6_LoadWaveInstrument:
	ld a, [wMusicWave]
	add a
	ld d, $0
	ld e, a
	ld hl, Music6_WaveInstruments
	add hl, de
	ld a, [hli]
	ld h, [hl]
	ld l, a
...
Music6_WaveInstruments:
INCLUDE "audio/wave_instruments.asm"

Music6_NoiseInstruments:
