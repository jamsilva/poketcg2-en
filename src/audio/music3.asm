...
_AssertSongFinished_3::
	jp Music3_AssertSongFinished

_AssertSFXFinished_3::
	jp Music3_AssertSFXFinished
...
_ResumeSong_3::
	jp Music3_ResumeSong

Music3_PlaySong:
	call Music3_LoadAudioWRAMBank
	push hl
	ld hl, NumberOfSongs3
	cp [hl]
	jr nc, .invalidID
	ld [wCurSongID], a
.invalidID
...
.zero_loop1
	...
	cp $4
	jr nz, .zero_loop1
	ld hl, Music3_ChannelLoopStacks
...
Music3_Update:
	call Music3_LoadAudioWRAMBank2
	call Music3_EmptyFunc
	call Music3_CheckForNewSound
	ld hl, SFX_UpdateSFX
...
.update_channels
	call Music3_UpdateChannel1
	call Music3_UpdateChannel2
	call Music3_UpdateChannel3
	call Music3_UpdateChannel4
...
Music3_CheckForNewSound:
	ld a, [wCurSongID]
	rla
	jr c, .check_for_new_sfx
	call Music3_StopAllChannels
	ld a, [wCurSongID]
	call Music3_BeginSong
	ld a, [wCurSongID]
	or $80
	ld [wCurSongID], a
.check_for_new_sfx
...
Music3_BeginSong:
	...
	ld [wAudio_d070], a
	ld [wAudio_d080], a
	ld a, [Music3_ChannelLoopStacks]
	ld [wMusicChannelStackPointers], a
	ld a, [Music3_ChannelLoopStacks + 1]
...
.no_channel_1
	...
	ld [wAudio_d070 + 1], a
	ld [wAudio_d080 + 1], a
	ld a, [Music3_ChannelLoopStacks + 2]
	ld [wMusicChannelStackPointers + 2], a
	ld a, [Music3_ChannelLoopStacks + 3]
...
.no_channel_2
	...
	ld [wAudio_d070 + 2], a
	ld [wAudio_d080 + 2], a
	ld a, [Music3_ChannelLoopStacks + 4]
	ld [wMusicChannelStackPointers + 4], a
	ld a, [Music3_ChannelLoopStacks + 5]
...
.no_channel_3
	...
	ld [wAudio_d070 + 3], a
	ld [wAudio_d087], a
	ld a, [Music3_ChannelLoopStacks + 6]
	ld [wMusicChannelStackPointers + 6], a
	ld a, [Music3_ChannelLoopStacks + 7]
...
Music3_CommandTable:
	...
	dw Music3_octave
	dw Music3_octave
	dw Music3_inc_octave
	dw Music3_dec_octave
	dw Music3_tie
	dw Music3_end
	dw Music3_end
	dw Music3_stereo_panning
	dw Music3_MainLoop
	dw Music3_EndMainLoop
	dw Music3_Loop
	dw Music3_EndLoop
	dw Music3_jp
	dw Music3_call
	dw Music3_ret
	dw Music3_frequency_offset
	dw Music3_duty
	dw Music3_volume
	dw Music3_wave
	dw Music3_cutoff
	dw Music3_echo
	dw Music3_vibrato_type
	dw Music3_vibrato_delay
	dw Music3_pitch_offset
	dw Music3_adjust_pitch_offset
	dw Music3_musicee
	dw Music3_musicef
	dw Music3_preset
	dw Music3_musicf1
...
Music3_Loop:
	...
	inc de
	push af
	call Music3_GetChannelStackPointer
	ld [hl], e ;
	...
	inc hl
	push de
	call Music3_SetChannelStackPointer
	jp Music3_PlayNextNote_pop
...
Music3_LoadWaveInstrument:
	ld a, [wMusicWave]
	add a
	ld d, $0
	ld e, a
	ld hl, Music3_WaveInstruments
	add hl, de
	ld a, [hli]
	ld h, [hl]
	ld l, a
...
Music3_WaveInstruments:
INCLUDE "audio/wave_instruments.asm"

Music3_NoiseInstruments:
