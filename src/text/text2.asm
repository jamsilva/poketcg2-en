...
PowerOfDarknessCheckText:
	text "If Heads, return 1 opponent Pokémon"
	line "& attached cards to his or her Hand."
	done
...
Choose2EnergyCardsFromDiscardPileForHandText:
	text "Choose 2 Energy cards from the"
	line "Discard Pile to place in the Hand."
	done
...
MaySelectMoreCardsButQuitPromptText:
	text "You can choose <RAMNUM> more cards. Quit?"
	done
...
TransmittingDeckConfigurationReceiverText:
	...
	line "Move the Game Boys close together."
	done
