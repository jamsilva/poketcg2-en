...
ChallengeDescription:
	text "Ask your opponent if he or she"
	line "accepts your challenge. If your"
	line "opponent declines (or if both"
	line "Benches are full), draw 2 cards."
	line "If your opponent accepts, each of"
	line "you searches your decks for any"
	line "number of Basic Pokémon cards and"
	done

ChallengeDescriptionCont:
	text "puts them onto your Benches."
	line "(A player can't do this if his or"
