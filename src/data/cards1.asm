...
DarkIvysaurCard:
	...
	tx SeedName ; category
	db DEX_IVYSAUR ; Pokedex number
	darkness_level TRUE, 16 ; is Dark?, level
IF METRIC
	length 1, 0 ; length
	weight 13.0 ; weight
ELSE
...
VenusaurAltLv67Card:
	db TYPE_PKMN_GRASS ; type
	gfx VenusaurAltLv67CardGfx ; gfx
	tx VenusaurName ; name
	db STAR ; rarity
	db PRO ; real set
	db PROMOTIONAL ; in-game set
...
DarkVenusaurCard:
	...
	tx SeedName ; category
	db DEX_VENUSAUR ; Pokedex number
	darkness_level TRUE, 37 ; is Dark?, level
IF METRIC
	length 2, 0 ; length
	weight 100.0 ; weight
ELSE
...
MetapodLv21Card:
	...
	tx CocoonName ; category
	db DEX_METAPOD ; Pokedex number
	darkness_level FALSE, 21 ; is Dark?, level
IF METRIC
	length 0, 7 ; length
	weight 9.9 ; weight
ELSE
...
DarkGloomCard:
	...
	tx WeedName ; category
	db DEX_GLOOM ; Pokedex number
	darkness_level TRUE, 21 ; is Dark?, level
IF METRIC
	length 0, 8 ; length
	weight 8.6 ; weight
ELSE
...
DarkVileplumeCard:
	...
	tx FlowerName ; category
	db DEX_VILEPLUME ; Pokedex number
	darkness_level TRUE, 29 ; is Dark?, level
IF METRIC
	length 1, 2 ; length
	weight 18.6 ; weight
ELSE
...
BellsproutLv11Card:
	...
	tx FlowerName ; category
	db DEX_BELLSPROUT ; Pokedex number
	darkness_level FALSE, 11 ; is Dark?, level
IF METRIC
	length 0, 7 ; length
	weight 4.0 ; weight
ELSE
...
CharizardLv76Card:
	...
	darkness_level FALSE, 76 ; is Dark?, level
IF METRIC
	length 1, 7 ; length
	weight 90.5 ; weight
ELSE
...
CharizardAltLv76Card:
	db TYPE_PKMN_FIRE ; type
	gfx CharizardAltLv76CardGfx ; gfx
	tx CharizardName ; name
	db STAR ; rarity
	db PRO ; real set
	db PROMOTIONAL ; in-game set
...
DarkCharizardCard:
	...
	tx FlameName ; category
	db DEX_CHARIZARD ; Pokedex number
	darkness_level TRUE, 38 ; is Dark?, level
IF METRIC
	length 1, 7 ; length
	weight 90.5 ; weight
ELSE
...
MagmarLv31Card:
	...
	tx SpitfireName ; category
	db DEX_MAGMAR ; Pokedex number
	darkness_level FALSE, 31 ; is Dark?, level
IF METRIC
	length 1, 3 ; length
	weight 44.5 ; weight
ELSE
...
BlastoiseLv52Card:
	...
	darkness_level FALSE, 52 ; is Dark?, level
IF METRIC
	length 1, 6 ; length
	weight 85.5 ; weight
ELSE
...
BlastoiseAltLv52Card:
	db TYPE_PKMN_WATER ; type
	gfx BlastoiseAltLv52CardGfx ; gfx
	tx BlastoiseName ; name
	db STAR ; rarity
	db PRO ; real set
	db PROMOTIONAL ; in-game set
...
MagikarpLv6Card:
	...
	darkness_level FALSE, 6 ; is Dark?, level
IF METRIC
	length 0, 9 ; length
	weight 10.0 ; weight
ELSE
...
DarkGyaradosCard:
	...
	tx AtrociousName ; category
	db DEX_GYARADOS ; Pokedex number
	darkness_level TRUE, 31 ; is Dark?, level
IF METRIC
	length 6, 5 ; length
	weight 235.0 ; weight
ELSE
...
FlyingPikachuLv12Card:
	db TYPE_PKMN_LIGHTNING ; type
	gfx FlyingPikachuLv12CardGfx ; gfx
...
FlyingPikachuAltLv12Card:
	db TYPE_PKMN_LIGHTNING ; type
	gfx FlyingPikachuAltLv12CardGfx ; gfx
	tx FlyingPikachuName ; name
	db PROMOSTAR ; rarity
	db PRO ; real set
	db PROMOTIONAL ; in-game set
...
DarkDugtrioCard:
	...
	tx MoleName ; category
	db DEX_DUGTRIO ; Pokedex number
	darkness_level TRUE, 18 ; is Dark?, level
IF METRIC
	length 0, 7 ; length
	weight 33.3 ; weight
ELSE
...
MankeyLv7Card:
	...
	darkness_level FALSE, 7 ; is Dark?, level
IF METRIC
	length 0, 5 ; length
	weight 28.0 ; weight
ELSE
